...
--
-- Host: localhost:3306
-- Generation Time: Sep 22, 2025 at 02:53 PM
...
(8, 'สมชาย', 'ใจดี', 'male', 'aum.kitsanapong@gmail.com', '_lza5VIAAAAJ', '$2a$10$sPaTxAZ.Bp4fxHGBg.awZ.a5jq72uWXeRAQHLK.3LTluhNoliaRYG', 1, 1, NULL, '2025-07-31 17:52:46', '2025-07-31 17:52:46', NULL),
...
(12, 'สมชาย', 'ใจดี', 'male', 'teacher@cpkku.ac.th', NULL, '$2a$10$6ZjpWSb79tlPLB4YViD/aet//OVVG2MigdyHqIrNX.RXyA6UVUaf.', 1, 1, NULL, '2025-09-22 14:48:29', '2025-09-22 14:48:29', NULL),
...
(332, 8, '779943c9-77ee-4d83-8884-8b289bc7c144', 'dF1kQvHfF6DbTQFT1nJnn4GvWMyXNAea9vrKETgqR3A=', 'Chrome Browser', 'web', '58.10.72.179', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/140.0.0.0 Safari/537.36', '2025-09-22 13:47:28', '2025-10-22 13:40:36', 1, '2025-09-22 13:40:36', '2025-09-22 13:47:28'),
...
--
ALTER TABLE `submissions`
  MODIFY `submission_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;

--
-- AUTO_INCREMENT for table `submission_documents`
--
ALTER TABLE `submission_documents`
  MODIFY `document_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
...
--
ALTER TABLE `user_sessions`
  MODIFY `session_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=334;

--
-- AUTO_INCREMENT for table `user_tokens`
--
ALTER TABLE `user_tokens`
  MODIFY `token_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=334;

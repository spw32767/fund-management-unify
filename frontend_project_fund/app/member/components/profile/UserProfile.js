                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end sm:gap-4">
                        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
                          ...
                          />
                          <div className="flex flex-1 flex-col gap-1 rounded-lg border border-gray-200 bg-gray-50 p-3 sm:flex-row sm:items-center sm:gap-3 sm:bg-white">
                            <div className="flex items-center gap-2 text-sm font-medium text-gray-700">
                              <Clock className="h-4 w-4 text-blue-500" />
                              <span>ช่วงปีเผยแพร่</span>
                            </div>
                            <div className="flex flex-wrap items-center gap-2 text-sm text-gray-700 sm:ml-auto">
                              <label className="flex items-center gap-1">
                                <span className="text-gray-500">จาก</span>
                                <select
                                  value={startYear}
                                  onChange={(e) => setStartYear(e.target.value)}
                                  className="min-w-[5rem] rounded-md border border-gray-300 bg-white px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                                >
                        ...
                        <button
                          ...
                          className="inline-flex items-center justify-center rounded-md border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:border-blue-200 hover:text-blue-700"

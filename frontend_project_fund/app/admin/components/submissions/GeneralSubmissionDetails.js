...
import {
  ...
  Eye, Download, PlusCircle, Loader2, ToggleLeft, ToggleRight,
} from 'lucide-react';
...
export default function GeneralSubmissionDetails({ submissionId, onBack }) {
  ...
  const handleEventSubmit = async (ev) => {
    ...
    if (eventForm.file) {
      formData.append('attachment', eventForm.file);
    }
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                >
                  {researchLoading && <Loader2 size={16} className="animate-spin" />}
                  โหลดล่าสุด
                </button>
              </div>

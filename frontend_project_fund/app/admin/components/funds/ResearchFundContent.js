// app/admin/components/funds/ResearchFundContent.js
// แสดงข้อมูลทุนส่งเสริมการวิจัยสำหรับผู้ดูแล (มุมมองเดียวกับสมาชิกแต่ปิดการยื่นขอทุน)
...
export default function ResearchFundContent({ onNavigate }) {
  ...
  const loadFundData = async (year, roleContext = userRole) => {
    try {
      ...
      // ถ้าอยู่นอกช่วงเวลา ให้เติม “สิ้นสุดรับคำขอ: …” ต่อท้าย fund_condition (เหมือนฝั่งสมาชิก)
  ...
  const renderFundRow = (fund) => {
    ...
    return (
      <tr
        ...
        className={!isWithinApplicationPeriod ? "bg-gray-50" : ""}
      >

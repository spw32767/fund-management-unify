      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <div className="md:col-span-2 mt-4 flex flex-col gap-2 pt-2 sm:flex-row sm:items-center sm:justify-end">
          <button
            type="button"
            onClick={onClose}
            className="inline-flex items-center gap-2 rounded-lg border border-gray-300 px-3 py-2 text-gray-700 transition hover:border-red-300 hover:bg-red-50 hover:text-red-600"
          >
            ยกเลิก
          </button>

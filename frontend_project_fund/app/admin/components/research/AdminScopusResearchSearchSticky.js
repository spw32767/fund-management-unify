// Variant: Sticky sidebar user list for Scopus research search
"use client";
...
export default function AdminScopusResearchSearchSticky() {
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr,2fr]">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="max-h-[70vh] overflow-y-auto">
              <table className="min-w-full divide-y divide-slate-200 text-sm">
                <thead className="sticky top-0 bg-slate-50 text-xs uppercase text-slate-600 shadow">
                  <tr>
        ...
        <div className="space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-6 rounded-xl border border-slate-100 bg-gradient-to-br from-white via-white to-slate-50 p-4 shadow-inner">

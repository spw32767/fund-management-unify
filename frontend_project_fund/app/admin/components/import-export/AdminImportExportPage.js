  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:px-6">
          <div>
            <h2 className="text-lg font-semibold text-slate-900">จัดการไฟล์เทมเพลต</h2>
            <p className="text-sm text-slate-600">อัปโหลด แก้ไข หรือลบไฟล์เทมเพลตสำหรับการนำเข้าข้อมูล</p>
          </div>
          <button
            type="button"
        ...
        <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
          <div className="flex flex-col gap-2 border-b border-slate-200 bg-slate-50 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-6">
            <div>
              <h2 className="text-lg font-semibold text-slate-900">ดาวน์โหลดไฟล์ตัวอย่าง / Templates</h2>

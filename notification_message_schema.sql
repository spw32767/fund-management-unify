...
VALUES
    ...
    -- แอดมินไม่อนุมัติ
    ('admin_rejected', 'user', 'ผลการตัดสินใจ: ไม่อนุมัติ', 'คำร้องหมายเลข {{submission_number}} ของคุณไม่ได้รับการอนุมัติ{{reason}}', 'ผลการตัดสินใจ: ไม่อนุมัติ', 'คำร้องหมายเลข {{submission_number}} ของคุณไม่ได้รับการอนุมัติ{{reason}}', 'แจ้งผลไม่อนุมัติพร้อมเหตุผล (ถ้ามี)', JSON_ARRAY('submission_number', 'reason'), JSON_ARRAY('submission_number', 'reason'));

...
VALUES
    ...
    (
        ...
        'admin',
        'มีคำร้องใหม่รอการพิจารณา (หมายเลข {{submission_number}})',
        'เรียน {{admin_name}}\n\nระบบกองทุนวิจัยฯ วิทยาลัยการคอมพิวเตอร์ขอแจ้งว่าได้รับคำร้องใหม่ มีรายละเอียดดังนี้\n\n- หมายเลขคำร้อง: {{submission_number}}\n- ชื่อผลงานทางวิชาการ: {{submission_title}}\n- ผู้ยื่นคำร้อง: {{submitter_name}}\n\nคำร้องดังกล่าวได้รับการเห็นควรพิจารณาโดยหัวหน้าสาขาแล้ว และรอให้ท่านพิจารณาดำเนินการต่อ โปรดเข้าสู่ระบบผ่านลิงก์นี้ {{web_url}} เพื่อดูรายละเอียดและดำเนินการตามขั้นตอน\n\nจึงเรียนมาเพื่อทราบ\n\nขอแสดงความนับถือ  \nระบบกองทุนวิจัยฯ  \nวิทยาลัยการคอมพิวเตอร์',
        'มีคำร้องใหม่รอการพิจารณา (หมายเลข {{submission_number}})',
        'เรียน {{admin_name}}\n\nระบบกองทุนวิจัยฯ วิทยาลัยการคอมพิวเตอร์ขอแจ้งว่าได้รับคำร้องใหม่ มีรายละเอียดดังนี้\n\n- หมายเลขคำร้อง: {{submission_number}}\n- ชื่อผลงานทางวิชาการ: {{submission_title}}\n- ผู้ยื่นคำร้อง: {{submitter_name}}\n\nคำร้องดังกล่าวได้รับการเห็นควรพิจารณาโดยหัวหน้าสาขาแล้ว และรอให้ท่านพิจารณาดำเนินการต่อ โปรดเข้าสู่ระบบผ่านลิงก์นี้ {{web_url}} เพื่อดูรายละเอียดและดำเนินการตามขั้นตอน\n\nจึงเรียนมาเพื่อทราบ\n\nขอแสดงความนับถือ  \nระบบกองทุนวิจัยฯ  \nวิทยาลัยการคอมพิวเตอร์',
